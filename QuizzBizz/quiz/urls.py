...
from quiz.api import MyQuizListAPI, QuizListAPI, QuizDetailAPI, SaveUsersAnswer, SubmitQuizAPI,  QuizRankingList
...
urlpatterns = [
	...
	re_path(r"ranking/(?P<slug>[\w\-]+)/$", QuizRankingList.as_view()),
]